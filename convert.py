...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_spk', type=str, default='SF1', help = 'target speaker.')
    parser.add_argument('--trg_spk', type=str, default='TM1', help = 'target speaker.')
    ...
    parser.add_argument('--wav_dir', type=str, default="./data/evaluation_all")
